...
const testimonials = [
  {
    ...
    company: "",
    content:
      "Como emprendedor digital, siempre buscaba un equipo que pudiera hacer realidad mis ideas sin complicaciones. Esta empresa de desarrollo de software ha sido clave en mi éxito. Su enfoque ágil y personalizado hizo que mi web estuviera lista en tiempo récord. ¡Altamente recomendados!",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "",
    content:
      "He trabajado con varias empresas de desarrollo, pero esta realmente entiende mis necesidades. Su equipo no solo creó una aplicación increíble, sino que también optimizó su rendimiento más allá de lo que imaginaba. ¡Es como tener un equipo de expertos siempre a mi disposición!",
    categories: [1, 2, 4],
  },
  {
    ...
    company: "",
    content:
      "Antes, el desarrollo de software era un cuello de botella en nuestro negocio. Desde que trabajamos con esta empresa, todo ha cambiado. Su enfoque estratégico y su capacidad para entregar soluciones escalables nos han permitido crecer sin límites. ¡Un verdadero socio tecnológico!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "",
    content:
      "La calidad del software que desarrollaron para nosotros superó todas nuestras expectativas. Su equipo no solo es altamente profesional, sino que también ofrece un soporte excepcional. Gracias a ellos, nuestro proyecto tomó vida y está funcionando sin problemas.",
    categories: [1, 4],
  },
  {
    ...
    company: "",
    content:
      "Siempre pensé que desarrollar software a medida sería un proceso largo y complicado, pero esta empresa lo hizo simple y eficiente. En pocas semanas tenía mi App web funcionando perfectamente y lista para escalar. No puedo estar más satisfecho con su trabajo.",
    categories: [1, 3, 5],
  },
  {
    ...
    company: "",
    content:
      "Desde el primer contacto, supe que estaba trabajando con profesionales. Me guiaron en cada paso del proceso y transformaron mi idea en una página funcional y atractiva. Su equipo es rápido, eficiente y creativo. ¡Definitivamente volveré a trabajar con ellos en futuros proyectos!",
    categories: [1, 3],
  },
  {
    ...
    company: "",
    content:
      "No solo crearon el software que necesitábamos, sino que lo hicieron con una precisión y rapidez sorprendentes. Su equipo entendió perfectamente nuestros requerimientos y nos entregó una solución intuitiva y escalable. ¡Son nuestros aliados tecnológicos de confianza!",
    categories: [1, 2, 5],
  },
  {
    ...
    company: "",
    content:
      "Trabajar con este equipo ha sido una de las mejores decisiones para nuestra empresa. Su nivel de compromiso y expertise nos permitió lanzar una plataforma robusta y segura en tiempo récord. Si buscas calidad y eficiencia, esta es la empresa indicada.",
    categories: [1, 4],
  },
  {
    ...
    company: "",
    content:
      "El desarrollo de nuestra aplicación fue un proceso fluido y bien organizado gracias a su profesionalismo. No solo cumplieron con los plazos, sino que también nos ofrecieron mejoras y optimizaciones que hicieron que el producto final superara nuestras expectativas. ¡Totalmente recomendados!",
    categories: [1, 2],
  },
];
    ...
    <div className="mx-auto max-w-6xl px-4 sm:px-6">
      <div className="border-t py-12 [border-image:linear-gradient(to_right,transparent,--theme(--color-slate-400/.25),transparent)1] md:py-20">
        ...
        <div className="mx-auto max-w-3xl pb-12 text-center">
          ...
          Confianza en Primera Persona
          </h2>
          <p className="text-lg text-indigo-200/65">
          Descubre cómo nuestros socios y clientes han transformado sus negocios gracias a nuestro compromiso y expertise en desarrollo digital.
          </p>
        </div>
