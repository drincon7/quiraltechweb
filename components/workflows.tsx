...
<a 
  ...
  <div className="relative z-20 h-full overflow-hidden rounded-[inherit] bg-gray-950">
    ...
    {/* Capa de contenido con pointer-events-none en la imagen */}
